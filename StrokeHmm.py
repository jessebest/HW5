...
class HMM:
    ...
    def label( self, data ):
        ...
        print "the classified labels are" , path[state]
        return path[state]
...
class StrokeLabeler:
    def __init__(self):
        ...
        self.featureNames = ['length','curvature','distance']
        self.contOrDisc = {'length': CONTINUOUS, 'curvature':CONTINUOUS, 'distance':CONTINUOUS}
    ...
    def featureTest( self, strokeFile ):
        ...
        for i in range(len(strokes)):
            ...
            print "Distance is", strokes[i].DistanceX()
